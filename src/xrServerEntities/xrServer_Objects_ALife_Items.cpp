...
bool CSE_ALifeItemAmmo::can_switch_online() const throw() { return inherited::can_switch_online(); }
...
bool CSE_ALifeItemBolt::used_ai_locations() const throw() { return false; }
#ifndef XRGAME_EXPORTS
