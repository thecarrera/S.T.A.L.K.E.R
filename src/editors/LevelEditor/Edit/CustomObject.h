...
public:
    ...
    bool__stdcall OnObjectNameAfterEdit(PropValue* sender, shared_str& edit_val);
    void__stdcall OnTransformChange(PropValue* value);
    void__stdcall OnMotionableChange(PropValue* sender);
    void__stdcall OnMotionCommandsClick(ButtonValue* value, bool& bModif, bool& bSafe);
    void__stdcall OnMotionFilesClick(ButtonValue* value, bool& bModif, bool& bSafe);
    void__stdcall OnMotionControlClick(ButtonValue* value, bool& bModif, bool& bSafe);
    void__stdcall OnMotionFrameChange(PropValue* value);
    void__stdcall OnMotionKeyTimeChange(PropValue* value);
...
protected:
    ...
    void__stdcall OnNameChange(PropValue* sender);
    void__stdcall OnChangeIngroupUnique(PropValue* sender);

    void__stdcall OnNumChangePosition(PropValue* sender);
    void__stdcall OnNumChangeRotation(PropValue* sender);
